...
public class AccesorioRepositorioImpl implements IAccesorioRepositorio{
	...
	@Override
	public Optional<Accesorio> buscarPorId(int idAccesorio) {
		return jpaRepositorio.findById(idAccesorio).map(entityMapper::toDomain);
	}
	...
	public void eliminar(int idAccesorio) {
		jpaRepositorio.deleteById(idAccesorio);
	}
}
