...
import com.uisrael.proyectoapi.aplicacion.casosuso.impl.AccionReparacionMaterialCasoUsoImpl;
...
import com.uisrael.proyectoapi.infraestructura.persistencia.adaptadores.AccionReparacionMaterialRepositorioImpl;
...
public class AplicacionConfig {
	...
	@Bean
	 IUsuarioCasoUso usuarioCasoUso(IUsuarioRepositorio repositorio, BCryptPasswordEncoder encoder) {
	    return new UsuarioCasoUsoImpl(repositorio, encoder);
	}
	// AccionReparacionMaterial
	@Bean
	IAccionReparacionMaterialRepositorio accionReparacionMaterialRepositorio(
	        IAccionReparacionMaterialJpaRepositorio jpaRepository,
	        IAccionReparacionMaterialJpaMapper mapper) {
	    return new AccionReparacionMaterialRepositorioImpl(jpaRepository, mapper);
	}

	@Bean
	IAccionReparacionMaterialCasoUso accionReparacionMaterialCasoUso(
	        IAccionReparacionMaterialRepositorio repositorio) {
	    return new AccionReparacionMaterialCasoUsoImpl(repositorio);
	}
